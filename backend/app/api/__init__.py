...
from app.api.endpoints import users, agents, agent_catalog, chat, chat_dev, chat_compute_tool, source_files, prompt_templates, tenants, qtn_projects, qtn_sources, qtn_catalogs, companies, scheduling, bi_projects, bi_sources, bi_schemas, test01
...
router.include_router(test01.router, prefix="/test01", tags=["test01"])
